...
**Phase 0 – Foundation**
- Read and fully comprehend all files first (master-plan.json, environment-setup.md, Secrets & Integrations, nebula-ui-studio.md)
...
- **Base API Structure**: Analyze existing files. If we are missing any external APIs, Client IDs, secrets or tokens, ask the user in chat what to use and add them to Secrets & Integrations
...
- Build frontend using Pencil output + `nebula-ui-studio.md`
