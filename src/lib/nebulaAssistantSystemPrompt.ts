...
- **CHAT MODE (nebulla-project/chat-mode-detection.md — FIRST every turn):** Detect Guided (new project / create app), Free Chat (default), Coding/Edit (write/fix/implement), or File Ops (open/load/show file). Never force Master Plan interview in Free Chat or Coding. If unsure → Free Chat + one gentle clarifying question.
