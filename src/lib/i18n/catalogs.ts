...
const enAppStatus: Catalog = {
  ...
  'appStatus.mockupWaiting': 'Mockup waiting',
  'appStatus.thinShell': 'Code shell — open Code',
...
const frAppStatus: Catalog = {
  ...
  'appStatus.mockupWaiting': 'Mockup en attente',
  'appStatus.thinShell': 'Coquille de code — ouvrir Code',
...
const itAppStatus: Catalog = {
  ...
  'appStatus.looksOk': 'App OK',
  'appStatus.mockupWaiting': 'Mockup in attesa',
  'appStatus.thinShell': 'Shell di codice — apri Code',
...
const esAppStatus: Catalog = {
  ...
  'appStatus.looksOk': 'App OK',
  'appStatus.mockupWaiting': 'Mockup en espera',
  'appStatus.thinShell': 'Cáscara de código — abrir Code',
...
const deAppStatus: Catalog = {
  ...
  'appStatus.looksOk': 'App OK',
  'appStatus.mockupWaiting': 'Mockup wartet',
  'appStatus.thinShell': 'Code-Hülle — Code öffnen',
