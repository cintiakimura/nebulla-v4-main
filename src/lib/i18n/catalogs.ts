...
const enAppStatus: Catalog = {
  ...
  'appStatus.thinShell': 'Thin code shell',
...
const frAppStatus: Catalog = {
  ...
  'appStatus.thinShell': 'Coquille de code mince',
...
const itAppStatus: Catalog = {
  ...
  'appStatus.thinShell': 'Shell di codice sottile',
...
const esAppStatus: Catalog = {
  ...
  'appStatus.thinShell': 'Cáscara de código',
...
const deAppStatus: Catalog = {
  ...
  'appStatus.thinShell': 'Dünne Code-Hülle',
