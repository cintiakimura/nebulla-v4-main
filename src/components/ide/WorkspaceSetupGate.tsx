        ...
        {phase.status === 'needs_login' ? (
          <div className="space-y-4">
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              Sign in with <strong className="font-normal text-slate-200">email</strong>, Google, or GitHub to save
              projects to the cloud. Grok receives your project name, workspace path, file index, and Master Plan on
              every message.
            </p>
            ...
            {!githubOk && cloudOk ? (
              <p className="text-xs text-amber-400/90">
                GitHub is optional — email or Google above still save your project.
              </p>
            ) : null}
            {!googleOk && cloudOk ? (
              <p className="text-xs text-amber-400/90">
                Google is optional — email or GitHub above still save your project.
              </p>
            ) : null}
            {!cloudOk ? (
