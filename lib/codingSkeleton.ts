...
7. app/globals.css uses §5 palette hex. If the user asked dark/calm/low-stimulus OR §5 is thin, use a dark calm default (deep ink background, muted text, one accent) — never leftover cream-on-white.
8. mockStore only. No live API unless they asked.`;
