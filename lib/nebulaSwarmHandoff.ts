 ...
 *   scoped to recently changed git paths + optional client snippets. Normal chat uses `GROK_API_KEY_LUMEN` only.
 */
...
export const NO_SWARM_AGENTS_NOTE =
  "Lean swarm: no support agents ran on this chat turn. Planning and research stay in main Grok (server GROK_API_KEY_LUMEN). Use **Inspect** when you want a scoped Quality pass on recently changed files (GROK_SWARM_API_KEY).";
