...
| **HTTP 4xx / 5xx** | 404 Not Found, 400 Bad Request, 500 Internal | Proper routing + global handlers | **404**, **400**, **500** | Missing route handler |
...
| **Cloud / Deployment** | Quota exceeded, cold starts | Monitoring, proper scaling | `QuotaExceeded`, **503** | No auto-scaling configured |
| **AI/ML Specific** | Hallucinations, OOM on inference | Grounding + quantization | `NaN` loss, `CUDA out of memory` | Unconstrained LLM output |
